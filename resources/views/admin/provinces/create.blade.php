...
<div class="flex items-center gap-2 text-[13px] text-gray-500 mb-6">
    ...
    <i class="ti ti-chevron-right text-xs"></i>
    <span class="text-gray-300">Tambah Provinsi</span>
</div>
...
<div class="max-w-xl">
    <form method="POST" action="{{ route('admin.provinces.store') }}">
        ...
        <div class="bg-surface border border-white/[0.07] rounded-xl p-5 mb-5">
            <label class="block text-[11px] text-gray-500 uppercase tracking-[1.5px] mb-2">Nama Provinsi <span class="text-red-400">*</span></label>
        ...
        <div class="flex items-center gap-3">
            <button type="submit"
                ...
                <i class="ti ti-device-floppy text-base"></i> Simpan Provinsi
            </button>
